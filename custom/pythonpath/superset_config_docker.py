...
SCREENSHOT_LOCATE_WAIT = int(get_env_variable("SCREENSHOT_LOCATE_WAIT", 10))
# Time before selenium times out after waiting for all DOM class elements named
# "loading" are gone.
SCREENSHOT_LOAD_WAIT = int(get_env_variable("SCREENSHOT_LOAD_WAIT", 60))
# Selenium destroy retries
SCREENSHOT_SELENIUM_RETRIES = int(get_env_variable("SCREENSHOT_SELENIUM_RETRIES", 5))
# Give selenium an headstart, in seconds
SCREENSHOT_SELENIUM_HEADSTART = int(get_env_variable("SCREENSHOT_SELENIUM_HEADSTART", 3))
# Wait for the chart animation, in seconds
SCREENSHOT_SELENIUM_ANIMATION_WAIT = int(get_env_variable("SCREENSHOT_SELENIUM_ANIMATION_WAIT", 5))
